...
//}
  ...
  $user = query("SELECT pegawai.*, desa.nm_desa FROM pegawai INNER JOIN desa ON pegawai.id_desa=desa.id_desa WHERE pegawai.is_delete=1 AND id_pegawai = $id")[0];
                      ...
                      <div class="modal-body">
                        <form >
                         ...
                         <div class="form-group">
                           <label for="password" class="col-form-label text-dark"> Password lama : </label>
                  ...
                  <div class="modal-header modal-bg  text-white bg-primary" back>
                      ...
                      <!-- <input type="text" name="alamat" id="alamat" placeholder="Alamat" class="form-control form-control-user"required> -->
                         ...
                         <div class="form-group">
                           ...
                           <label for="id_desa" class="col-form-label text-dark"> Desa : </label>
                          <?php $get_desa = mysqli_query($koneksi, "SELECT * FROM desa");
                            ?>
