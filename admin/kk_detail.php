...
if (isset($_SESSION["pegawai"])){
  ...
  if(isset($_POST["status_pmks"])){
  // var_dump($_POST);die;
  if(statusDataPmks($_POST)>0){
    echo"
       <script>
       alert('data berhasil di ubah');
       document.location.href='kk_detail.php?id=$id';
...
?>
                  ...
                  <?php foreach ($pmks as $row1):?>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-left"><?=$row1['hsl_survei'];?></td>
                        <td class="text-center">
                          <form method="POST">
                             <button type="button" id="status_pmks" name="status_pmks" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modalStatusPmks<?= $row1['id_pmks']; ?>">
                            <i class="fas fa-edit"></i> konfirmasi</button>
      ...
      <!-- Modal Edit Data -->
                        ...
                        <form>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" max = "2021-12-31" class="form-control mt-1" id="tgl_lhr_kpl" name="tgl_lhr_kpl" value="<?=$row['tgl_lhr_kpl']?>" required>
                            </div>
                     ...
                     <form method="post" enctype="multipart/form-data">
                       ...
                       <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                              <label for="tgl_lhr_pmks" class="col-form-label">Tanggal Lahir PMKS:</label>
                              <input type="text" class="form-control mt-1" id="tgl_lhr_pmks" name="tgl_lhr_pmks" 
              ...
              <!-- Modal Edit Survei-->
              <?php foreach ($pmks as $row1)  : ?>
              <div class="modal fade" id="modalStatusPmks<?=$row1['id_pmks'] ?>" tabindex="-2" role="dialog" 
                    aria-labelledby="modalStatusPmksDataTitle" aria-hidden="true">
                 <div class="modal-dialog modal-dialog-centered " role="document">
                   <div class="modal-content ">
                     <form method="post" enctype="multipart/form-data">
                       <div class="modal-header modal-bg bg-info" back>
                         <h5 class="modal-title modal-text" id="modalStatusPmksDataTitle">Edit Data PMKS</h5>
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                         </button>
                       </div>
                       <div class="modal-body">
                        <form>
                            ...
                            <label for="hsl_survei">Status Survei PMKS:</label>
                              <select class="form-control" id="hsl_survei" name="hsl_survei">
                                <option value="Menunggu"
                                              <?php  if ($row1['hsl_survei']=='Menunggu') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?> 
                                ...
                                <option value="Diterima"
                                              <?php  if ($row1['hsl_survei']=='Diterima') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?> 
                                ...
                                <option value="Ditolak"
                                              <?php  if ($row1['hsl_survei']=='Ditolak') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?> 
                         ...
                         <div class="modal-footer">
                           <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                           <button type="submit" name="status_pmks" class="btn btn-primary">Update</button>
                         </div>
                       </form>
                     </div>
                    </form>
