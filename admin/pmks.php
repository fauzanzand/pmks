        ...
        <div class="container-fluid">
          ...
          <!-- isi content -->
              <div class="card shadow mb-2">
                ...
                <form method="post" enctype="multipart/form-data" action="upload.php?data=KK"> 
                   Import data excel: <input name="userfile" type="file">
                   <input name="upload"  class="btn btn-sm btn-info" type="submit" value="import">
                    <br>
                  <br>
